...
public class DESOC 
{
	public static class DESOCMapper extends Mapper < LongWritable, Text, Text, LongWritable > 
	{
	...
	public static class DESOCReducer extends Reducer < Text, LongWritable, NullWritable, Text > 
	{
