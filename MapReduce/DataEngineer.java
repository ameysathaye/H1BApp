...
{
	public static class DataEngineerMapper extends Mapper<LongWritable,Text,Text,LongWritable>	
	{
	...
	public static class DataEngineerReducer extends Reducer < Text, LongWritable, NullWritable, Text > 
	{
	...
	public static class DataEngineerPartitioner extends Partitioner < Text, LongWritable > 
	{
	...
	job.setPartitionerClass(DataEngineerPartitioner.class);
