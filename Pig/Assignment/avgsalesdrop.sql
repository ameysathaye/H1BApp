...
intermed = foreach avgsales generate $0,$1,ROUND_TO((($2+$3)/2),2) as percloss;

final = FILTER intermed BY percloss<=-5.0;

store final into '/home/hduser/niit/pig/avg5drop' using PigStorage(',');
