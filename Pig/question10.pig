...
data1 = LOAD 'hdfs://localhost:54310/user/hive/warehouse/niit_h1b.db/h1b_final' USING PigStorage('\t') as (s_no:double,case_status:chararray,employer_name:chararray,soc_name:chararray,job_title:chararray,full_time_position:chararray,prevailing_wage:double,year:chararray,worksite:chararray,longitude,latitude);
...
store finaloutput into 'hdfs://localhost:54310/Project/question10' using PigStorage('\t');
